...
public interface MeokuMealOrderGroupRepository extends JpaRepository<MeokuMealOrderGroup, Integer> {
    ...
    MeokuMealOrderGroup findByMealOrderStartDateLessThanEqualAndMealOrderEndDateGreaterThanEqual(Timestamp startDate, Timestamp endDate);//입력 받은 날짜가 해당하는 배식 Group 가져오기
